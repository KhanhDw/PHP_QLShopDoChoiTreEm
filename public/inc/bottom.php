        ...
        <footer class="py-5 bg-info">
            ...
            <div class="container">
                ...
                <hr>
                <p class="m-0 text-center text-warning fw-bolder">Copyright &copy; Đồ chơi shop PNK</p></div>
        </footer>
