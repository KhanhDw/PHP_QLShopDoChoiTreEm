...
<html lang="en">
    <head>
        ...
        <title>Shop đồ chơi của bé</title>
    ...
    <body id="top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-info shadow">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.php"><i class="bi bi-shop-window"></i> Shop đồ chơi của PNK</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php if(isset($_SESSION["nguoidung"])){ ?>
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            <li class="nav-item"><a class="nav-link text-warning" href="index.php?action=thongtin" >Chào <?php echo $_SESSION["nguoidung"]["hoten"]; ?></a></li>
