...
<div class="my-3">    
	...
	<input class="form-control" type="text" name="txttendochoi" required value="<?php echo $m["tendochoi"]; ?>">
</div> 
<div class="my-3">    
	<label>Tên thương hiệu</label>    
	<input class="form-control" type="text" name="txtthuonghieu" required value="<?php echo $m["thuonghieu"]; ?>">
</div> 
<div class="my-3">    
	<label>Xuất xứ</label>    
	<input class="form-control" type="text" name="txtxuatxu" required value="<?php echo $m["xuatxu"]; ?>">
</div> 
<div class="my-3">    
	<label>Độ tuổi</label>    
	<input class="form-control" type="text" name="txtdotuoi" required value="<?php echo $m["dotuoi"]; ?>">
</div> 
<div class="my-3">    
	<label>Năm sản xuất</label>    
	<input class="form-control" type="text" name="txtnamsanxuat" required value="<?php echo $m["namsanxuat"]; ?>">
</div> 
<div class="my-3">    
	<label>Giá gốc</label>    
...
<div class="my-3">    
	<label>Giảm</label>    
	<input class="form-control" type="number" name="txtgiam" value="<?php echo $m["giam"]; ?>">
</div> 
<div class="my-3">    
	<label>Số lượng tồn</label>    
	<input class="form-control" type="number" name="txtsoluong" value="<?php echo $m["soluong"]; ?>" required>
</div> 
<div class="my-3">    
	<label>Mô tả</label>    
